...
describe("Employee Manager 1.2", () => {
    ...
    describe("handles unsaved, canceled, and saved changes correctly", () => {
       ...
       await driver.findElement(bernice).click();
        ...
        /* Lines 61-71 is describing the following:
        1.Waiting for the test to find the specific drvier
        2.It's finding the specific name of the input realted to nameInput.Which is Bernice
        3. Once this test is complete the end result should be Bernice Ortize
        */
        ...
        // line 102 is descrbing when a change is made on EM 1.2 once the change is made to verify it will stay the same!
        // I still cannot figure out why this portion of my test is failing =(
...
// If the error message doesn't appear then npx jest test will fail! 
// Checking to see if my changes have saved 2/20/23
